...
describe('Buttons and functions', () => {
  ...
  it(
    'test if handleInput is activated by clicking enter',
    successfulFunctionCall('handleInput', '#equalsButton')
  )
  it('test if delete runs ', successfulFunctionCall('handleInput', '#deleteButton'))
  it(
    'test if handleInput is activated by clicking 1',
    successfulFunctionCall('handleInput', '#button1')
  )
  it(
    'test if handleInput is activated by clicking 2',
    successfulFunctionCall('handleInput', '#button2')
  )
